...
export function Sidebar() {
  ...
  return (
    <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-40 hidden lg:block group/sidebar">
      <div className="overflow-visible relative py-5 text-sm font-semibold rounded-xl border border-solid bg-slate-900 bg-opacity-40 group-hover/sidebar:bg-opacity-70 border-white border-opacity-10 w-[80px] group-hover/sidebar:w-[200px] transition-all duration-300 ease-in-out">
            ...
            if (item.isProfile) {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`
                      absolute left-full top-1/2 -translate-y-1/2 ml-2 min-w-[160px] border border-white border-opacity-10 rounded-lg shadow-lg py-2 px-2 flex flex-col gap-1 transition-all duration-200
                      ${profileHover ? "opacity-100 pointer-events-auto translate-x-0" : "opacity-0 pointer-events-none -translate-x-2"}
                    `}
                    style={{
                      backgroundColor: "rgba(30, 41, 59, 0.4)", // bg-slate-900 bg-opacity-40
                      backgroundRepeat: "repeat",
                  ...
                  >
                    <Link
                      href="/profile"
                      className="flex items-center gap-2 px-3 py-2 rounded hover:bg-white/10 text-white text-sm"
                    >
                    ...
                    <button
                      onClick={logout}
                      className="flex items-center gap-2 px-3 py-2 rounded hover:bg-red-900/40 text-red-400 text-sm transition-colors"
                    >
